...
def gemma_4b_inference_engine(prompt_text, system_instruction=None):
    ...
    # Сверхплаский промпт-шаблон, адаптированный под возможности модели 4B (Правка Шага 4)
    default_system = (
        "You are a strict M&A financial analyst. Analyze the provided SEC Item 4 text.\n"
        "CRITICAL INSTRUCTION: Strictly ignore all standard, boilerplate declarations regarding potential future purchases or sales of shares in the open market depending on market conditions. Focus ONLY on concrete, active and aggressive corporate actions: demands for Board of Directors seats, assets or segments divestitures/sales, replacement of executive management/CEO, distribution of special dividends, or explicit amendments to the corporate charter or bylaws.\n"
        "You MUST classify the investor's strategic intent into exactly one of these classes:\n"
