...
def check_whale_catalysts(influential_shareholders, sec_ma_hints=None):
    ...
    # Формируем текстовый пул из свежих SEC уведомлений за этот год для перекрестной проверки
    sec_text_pool = ""
    if sec_ma_hints:
